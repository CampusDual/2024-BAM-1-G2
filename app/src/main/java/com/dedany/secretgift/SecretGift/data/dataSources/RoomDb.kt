package com.dedany.secretgift.SecretGift.data.dataSources
...
abstract class RoomDb : RoomDatabase() { //1.La clase creada debe ser "abstract"
    ...
    companion object {
        ...
        operator fun invoke(context: Context) = instance ?: synchronized(obj) {// 5. Funcion invoke que lleva la logica de llamar a crear la base de datos
